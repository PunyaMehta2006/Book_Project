      ...
      <div className="px-8 py-9 text-center sm:px-9 sm:py-9">
        ...
        <div className="flex items-center justify-center gap-3 pt-0.5">
          {book.price ? (
            ...
            <span className="font-body text-sm text-charcoal-muted italic">
              Price not set
            </span>
          ) : null}

          {book.exchangeAvailable && (
            <span className="inline-flex items-center justify-center gap-1 bg-sage-light/20 text-sage-dark font-body font-semibold text-xs px-2.5 py-1 rounded-full border border-sage-light/40">
